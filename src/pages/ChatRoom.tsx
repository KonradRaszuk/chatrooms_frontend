...
import { useChatroomSocket } from '../hooks/chatroom-socket';
...
export default function ChatRoom({}: Props) {
  ...
  const {data, isLoading, isError, error} = useGetChatroomMessages(id)

  const {data: user, isLoading: isUserLoading } = useMe()

  const {data: chatroomData, isLoading: chatroomIsLoading, isError: chatroomIsError, error: chatroomError} = useGetChatroomById(id)
  ...
  if (isLoading || isUserLoading || chatroomIsLoading) return (
  ...
  if (isError || chatroomIsError) return (
    <div className='chatroom_wrapper'>
      <div className='loading_spinner_wrapper'>
        <p>Wystąpił błąd</p>
      </div>
  ...
  return (
    <div className='chatroom_wrapper'>
      ...
      <div className='chat_wrapper'>
        ...
        <div className='chat_prompt'> {/* pole input */}
          <input 
            type="text"
